...
//        System.out.print("Request ID: "+this.requestID+" Client ID: "+this.clientID + " VIN number: " +this.carVin + " Brand: " + this.brandID
...
//    }
    ...
    public String toString(){
        ...
        System.out.print("Request ID: "+this.requestID+" Client names: "+user.getUserNames(this.clientID) + " VIN number: " +this.carVin + " Brand: " + user.getBrandName(this.brandID)
                + " Model: " + user.getModelName(this.modelID) + " Date of leaving: "
                + this.dateLeave + " Date of taking: " + this.datePickUp
                + " Service: " + user.getService(this.service) + " Status: " + this.status + "\n");
        return "";
    }
}
